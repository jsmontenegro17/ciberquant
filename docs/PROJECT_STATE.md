...
## Partial
REQ-003 market data ingestion and deterministic candle cataloger are implemented on the feature branch and undergoing validation. Behavioural analytics remain future scope. RiskProfile retains the user-scoped Foundation model; profile editing/account-specific assignments are not part of this delivery.
...
REQ-003 — Market Data Ingestion & Candle Cataloger: IN_PROGRESS on codex/req-003-market-data-cataloger. REQ-002 remains DONE, integrated in PR #1.
...
## Active requirements
REQ-003: IN_PROGRESS. REQ-001/REQ-002: DONE. New quant behavior is descriptive only, not strategy recommendations. REQ-003 must pass PR/CI/QA and separate human acceptance before merge.
