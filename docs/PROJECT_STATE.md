...
## Current version
0.4.0. REQ-004 Human Acceptance PASS; release integration/CI/tag evidence is recorded in PR #3 and the requirement delivery report.
...
## Foundation only
Strategies, validation and backtesting remain future contracts; indicators and Feature Lab are implemented and accepted in REQ-004.

## Planned
Strategies, validation, backtesting and live scanning.

## Modules in development
None. REQ-004 — DONE, Human Acceptance PASS. Delivery tracked in [PR #3](https://github.com/jsmontenegro17/ciberquant/pull/3): pure cq-features-v1, reproducible snapshot APIs and Feature Lab;90 backend tests,22 frontend tests,3 E2E pass. No schema change or new migration. REQ-003 and REQ-002 remain DONE.
...
## Active requirements
None. [REQ-004](requirements/REQ-004-feature-indicator-engine.md): DONE, Human Acceptance PASS. REQ-001/REQ-002/REQ-003: DONE. No strategies, trading recommendations, binary outcome engine or backtesting implemented.
...
REQ-004 is closed; subsequent requirements require independent authorization and are not started.
