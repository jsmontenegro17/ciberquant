...
| D snapshot/backfill | replay same ceiling after earlier backfill/future append, SQLite and CI PostgreSQL | PASS locally; PostgreSQL pending CI |
...
Remote CI/PR evidence will be appended after validation. Do not merge or start REQ-005.
