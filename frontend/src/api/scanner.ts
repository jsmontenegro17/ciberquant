...
export interface Evidence {payout_product?:string|null;payout_snapshot?:string|null;payout_source?:string;expiry_bars?:number|null;expiry_source?:string;validation_expiry?:number|null;state?:string;mode?:string;strategy_name?:string;version?:number;research_direction?:string;validation_state?:string;dataset_validation_state?:string;validation_payout?:string|null;current_payout?:string|null;current_break_even?:string|null;payout_warning?:boolean;signal_time?:string;signal_open?:string;latency_ms?:number|null;next_entry_boundary?:string;error?:string;features?:unknown;signal_context?:unknown;health?:Record<string,unknown>}
export interface WatchItem {id:number;watchlist_id:number;provider:string;dataset:Dataset;strategy_version_id:number;research_mode:boolean;research_payout?:string|null;research_expiry?:number|null;enabled:boolean;state:string;latest:Evidence|null}
